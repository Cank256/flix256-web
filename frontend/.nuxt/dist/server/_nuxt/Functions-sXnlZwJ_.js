...
import { a as useRequestEvent, b as useRuntimeConfig, d as useNuxtApp, u as useHead, e as defineStore } from "../server.mjs";
import { computed, defineComponent, ref, h, mergeProps, withCtx, createVNode, openBlock, createBlock, toDisplayString, createCommentVNode, useSSRContext } from "vue";
...
const trailer = {
  computed: {
    trailer() {
      var _a;
      let videos = ((_a = this.item.videos) == null ? void 0 : _a.results) ?? [];
      if (!videos.length)
        return null;
...
const directors = {
  computed: {
    directors() {
      var _a;
      const people = ((_a = this.item.credits) == null ? void 0 : _a.crew) ?? [];
      if (people) {
...
export {
  ...
  stars as s,
  trailer as t,
  useBackendStore as u,
  yearStart as y
};
//# sourceMappingURL=Functions-sXnlZwJ_.js.map
