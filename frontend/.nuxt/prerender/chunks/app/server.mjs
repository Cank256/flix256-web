import { watch, reactive, hasInjectionContext, getCurrentInstance, version, ref, watchEffect, defineAsyncComponent, defineComponent, h, inject, computed, unref, provide, shallowReactive, Suspense, nextTick, Transition, useSSRContext, mergeProps, withCtx, createVNode, createApp, effectScope, markRaw, isRef, isReactive, toRef, toRaw, getCurrentScope, onScopeDispose, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, shallowRef, isReadonly, toRefs, isShallow } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/ofetch/dist/node.mjs';
...
import { getContext } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames, unpackMeta } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode, getRequestHeaders } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/ufo/dist/index.mjs';
...
import { setupDevtoolsPlugin } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-qTpe_m5V.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-VU57ixJX.mjs').then((m) => m.default || m)
  },
  {
    name: "movie-id",
    path: "/movie/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-rdexL4-B.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_name_-r4X7oFmo.mjs').then((m) => m.default || m)
  },
  {
    name: "movie",
    path: "/movie",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-yX4AC8Vk.mjs').then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-k4olhZ62.mjs').then((m) => m.default || m)
  },
  {
    name: "tv-id",
    path: "/tv/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-YuW5oG1l.mjs').then((m) => m.default || m)
  },
  {
    name: "tv-category-name",
    path: "/tv/category/:name()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_name_-_-0_gMpN.mjs').then((m) => m.default || m)
  },
  {
    name: "tv",
    path: "/tv",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-CVuBUGLy.mjs').then((m) => m.default || m)
  }
];
...
const LazyFooter = defineAsyncComponent(() => import('./_nuxt/Footer-qSdJApEB.mjs').then((r) => r.default));
const LazyMobileNav = defineAsyncComponent(() => import('./_nuxt/MobileNav-iMh3ObFn.mjs').then((r) => r.default));
const LazyMobileTopNav = defineAsyncComponent(() => import('./_nuxt/MobileTopNav-vOpzzKxZ.mjs').then((r) => r.default));
const LazyNavBar = defineAsyncComponent(() => import('./_nuxt/NavBar-a5FUaGkb.mjs').then((r) => r.default));
const LazyTopNav = defineAsyncComponent(() => import('./_nuxt/TopNav-KHiANXZu.mjs').then((r) => r.default));
const lazyGlobalComponents = [
  ["Footer", LazyFooter],
  ["MobileNav", LazyMobileNav],
  ["MobileTopNav", LazyMobileTopNav],
  ["NavBar", LazyNavBar],
  ["TopNav", LazyTopNav]
];
...
const vuex_F8JCgj45hr = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: () => import('./_nuxt/default-ix4tAyEI.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-YzC4PEPn.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-rqLxnE9k.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-0iIy4sfp.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useRequestEvent as a, useRuntimeConfig as b, createError as c, useNuxtApp as d, entry$1 as default, defineStore as e, useRouter as f, navigateTo as g, nuxtLinkDefaults as n, useHead as u };
