...
import { useSSRContext, ref, resolveComponent, mergeProps } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr } from 'file:///Users/caleb/Dev/ALX/Portifolio%20Project/source/flix256-web/frontend/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-yVxbj29m.mjs';
import { n as name$1, y as yearStart, c as yearEnd, u as useBackendStore, a as apiImgUrl$1, e as creators, f as __nuxt_component_0$1$1 } from './Functions-sXnlZwJ_.mjs';
  ...
  computed: {
    poster() {
      if (this.episode.still_path) {
        return `${apiImgUrl$1}/w400${this.episode.still_path}`;
      } else {
        return null;
      }
    }
  ...
  computed: {
    ...
    metaImage() {
      if (this.item && this.item.poster_path) {
        return `${apiImgUrl$1}/w500${this.item.poster_path}`;
      } else {
        return "";
      }
    },
...
//# sourceMappingURL=_id_-YuW5oG1l.mjs.map
