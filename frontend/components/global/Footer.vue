<template>
    <footer :class="$style.footer">
        <center>
            <p>&copy; {{ new Date().getFullYear() }} Cank256. All rights reserved.</p>
            <p>Built by <a target="_blank" href="https://www.github.com/Cank256">Cank256</a>, data provided by <a target="_blank" href="https://www.themoviedb.org/" rel="noopener">TMDb</a>.</p>
        
            <ul class="nolist">
                <li>
                    <a
                        href="https://www.linkedin.com/in/nkunzecaleb/"
                        target="_blank"
                ...
                <li>
                    <a
                        href="mailto:nkunzecaleb@gmail.com"
