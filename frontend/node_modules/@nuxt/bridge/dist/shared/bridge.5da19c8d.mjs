import { useNuxt, addPluginTemplate, tryImportModule, resolvePath, resolveFiles, addTemplate, resolveAlias, addWebpackPlugin, addVitePlugin, addPlugin, extendWebpackConfig, defineNuxtModule, logger, addComponent, addImportsSources, installModule, writeTypes as writeTypes$1, checkNuxtCompatibility } from '@nuxt/kit';
...
function setupTypescript({ isTSX }) {
  const nuxt = useNuxt();
